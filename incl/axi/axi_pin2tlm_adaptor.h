...
inline axi_pin2tlm_adaptor<BUSWIDTH, ADDRWIDTH, IDWIDTH>::axi_pin2tlm_adaptor::axi_pin2tlm_adaptor(
...
template <unsigned int BUSWIDTH, unsigned int ADDRWIDTH, unsigned int IDWIDTH>
inline tlm::tlm_sync_enum axi_pin2tlm_adaptor<BUSWIDTH, ADDRWIDTH, IDWIDTH>::axi_pin2tlm_adaptor::nb_transport_bw(
...
template <unsigned int BUSWIDTH, unsigned int ADDRWIDTH, unsigned int IDWIDTH>
void axi_pin2tlm_adaptor<BUSWIDTH, ADDRWIDTH, IDWIDTH>::register_trans(unsigned int axi_id, payload_type& trans,
                                                                       phase_type phase) {
