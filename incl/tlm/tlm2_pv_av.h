...
template <unsigned int BUSWIDTH = 32,
    ...
    >
class tlm2_pv_av_target_adapter: public sc_core::sc_module, public tlm::tlm_fw_transport_if<TYPES>, public tlm::tlm_bw_transport_if<TYPES> {
public:
  ...
  tlm2_pv_av_target_adapter(): tlm2_pv_av_target_adapter(sc_core::sc_gen_unique_name("tlm_pv_av_split")){
  }

  tlm2_pv_av_target_adapter(sc_core::sc_module_name const &  nm): sc_core::sc_module(nm){
    tsck.bind(*this);
  }
...
template <unsigned int BUSWIDTH = 32,
    ...
    typename ISOCKET_TYPE=tlm::tlm_initiator_socket<BUSWIDTH, TYPES, N, POL>
    >
class tlm2_pv_av_initiator_adapter: public sc_core::sc_module, public tlm::tlm_fw_transport_if<TYPES>, public tlm::tlm_bw_transport_if<TYPES> {
public:
  using tlm_payload_type = typename TYPES::tlm_payload_type;
  using tlm_phase_type = typename TYPES::tlm_phase_type;
  using target_socket_type = TSOCKET_TYPE;
  ...
  tlm2_pv_av_initiator_adapter(): tlm2_pv_av_initiator_adapter(sc_core::sc_gen_unique_name("tlm_pv_av_split")){
  }

  tlm2_pv_av_initiator_adapter(sc_core::sc_module_name const &  nm): sc_core::sc_module(nm){
    isck.bind(*this);
  }
