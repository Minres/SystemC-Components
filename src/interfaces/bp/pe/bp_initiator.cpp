...
#include "bp_initiator.h"

#include <scc/report.h>

using namespace sc_core;
using namespace bp;
using namespace bp::pe;
...
bp_initiator_b::bp_initiator_b(sc_core::sc_module_name nm, sc_core::sc_port_b<tlm::tlm_fw_transport_if<tlm::tlm_base_protocol_types>>& port,
                               size_t transfer_width, bool coherent)
: sc_module(nm)
, socket_fw(port)
, transfer_width_in_bytes(transfer_width / 8) {}

bp_initiator_b::~bp_initiator_b() = default;

tlm::tlm_sync_enum bp_initiator_b::nb_transport_bw(payload_type& trans, phase_type& phase, sc_core::sc_time& t) {

    peq.notify(std::make_tuple(&trans, phase), t);
    return tlm::TLM_ACCEPTED;
}

void bp_initiator_b::invalidate_direct_mem_ptr(sc_dt::uint64 start_range, sc_dt::uint64 end_range) {}

void bp_initiator_b::transport(payload_type& trans, bool lt_transport) {
