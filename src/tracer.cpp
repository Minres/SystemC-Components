...
#define GEN_TRACE(X)                                                                                                   \
    {                                                                                                                  \
        sc_core::sc_signal<X> *sig = dynamic_cast<sc_core::sc_signal<X> *>(obj);                                       \
...
#define GEN_TRACE(X)                                                                                                   \
    {                                                                                                                  \
        sc_core::sc_in<X> *in_port = dynamic_cast<sc_core::sc_in<X> *>(obj);                                           \
        if (in_port) {                                                                                                 \
...
#define GEN_TRACE(X)                                                                                                   \
    {                                                                                                                  \
        sc_core::sc_inout<X> *io_port = dynamic_cast<sc_core::sc_inout<X> *>(obj);                                     \
        if (io_port) {                                                                                                 \
