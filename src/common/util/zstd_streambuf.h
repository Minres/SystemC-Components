...
#ifndef _UTIL_ZSTD_STREAMBUF_H_
#define _UTIL_ZSTD_STREAMBUF_H_
...
public:
    explicit zstd_streambuf(const std::string& path);

    ~zstd_streambuf() override;
