...
private:
    ...
    void clk_delay() {
        clk_delayed.notify(OCP_CLK_DELAY);
    }
    void req();
    void resp();
...
inline tlm::tlm_sync_enum ocp::pin::target<DATA_WIDTH, ADDR_WIDTH, BUSWIDTH>::nb_transport_bw(payload_type& trans, phase_type& phase, sc_core::sc_time& t) {
...
template <unsigned DATA_WIDTH, unsigned ADDR_WIDTH, unsigned BUSWIDTH>
inline void ocp::pin::target<DATA_WIDTH, ADDR_WIDTH, BUSWIDTH>::invalidate_direct_mem_ptr(sc_dt::uint64 start_range, sc_dt::uint64 end_range) {}
