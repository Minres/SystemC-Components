...
#ifndef TLM_NW_TLM_ARRAY_H_INCLUDED_
#define TLM_NW_TLM_ARRAY_H_INCLUDED_
...
// request. The class is primarily used for storing the pointers to the extensions.
//
...
template <typename T> class tlm_array : private std::vector<T> {
...
template <typename T> const char* const tlm_array<T>::kind_string = "tlm_array";
