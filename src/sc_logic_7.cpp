...
void
sc_logic_7::invalid_value( sc_logic_7_value_t v )
{
    char msg[BUFSIZ];
...
void
sc_logic_7::invalid_value( char c )
{
    char msg[BUFSIZ];
...
void
sc_logic_7::invalid_value( int i )
{
    char msg[BUFSIZ];
...
const sc_logic_7_value_t sc_logic_7::and_table[7][7] =
{     //0      1      L      H      Z      X      U
...
const sc_logic_7_value_t sc_logic_7::or_table[7][7] =
{     //0      1      L      H      Z      X      U
...
const sc_logic_7_value_t sc_logic_7::xor_table[7][7] =
{     //0      1      L      H      Z      X      U
...
void
sc_logic_7::scan( ::std::istream& is )
{
    char c;
    is >> c;
    *this = c;
