...
// ----------------------------------------
template <typename T> class _scv_extension_rw_base : public _SCV_INTROSPECTION_BASE {
public:
...
// ----------------------------------------
template <typename T, int N> class scv_extension_rw<T[N]> : public _SCV_INTROSPECTION_BASE2 {
    typedef T my_type[N];
...
// ----------------------------------------
template <typename T> class scv_extension_rw<T*> : public _SCV_INTROSPECTION_BASE1 {
public: // public API for use only when full type information is available
...
// ----------------------------------------
class _scv_extension_rw_enum : public _SCV_INTROSPECTION_BASE_ENUM {
public:
