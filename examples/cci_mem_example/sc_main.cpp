...
int sc_main(int argc, char *argv[]) {
    ...
    auto memories = portal.get_memories(cci_mem::memory_type::ALL);
    for(auto m:memories) {
    	SCCINFO()<<"Found storage '"<<m->get_name()<<"' of type "<<m->get_type()<<" with description: '"<<m->get_description()<<"', size: "<<m->get_size()<<" and width: "<<m->get_width();
    }
